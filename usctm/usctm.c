...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4,17,0)
    static int sys_put_data = (int) __x64_sys_put_data;
    static int sys_get_data = (int) __x64_sys_get_data;
    static int sys_invalidate_data = (int) __x64_sys_invalidate_data;
